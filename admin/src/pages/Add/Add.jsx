...
const Add = ({url}) => {
    ...
    const[data,setData]=React.useState({name:'',description:'',price:'',category:'Salad'})
    ...
    <div className='add'>
        <form className="flex-col" onSubmit={onSubmitHandler}>
            <div className="add-img-upload flex-col">
                ...
                <input onChange={(prev)=>setImage(prev.target.files[0])}type="file" id="image" hidden required/>
            </div>
